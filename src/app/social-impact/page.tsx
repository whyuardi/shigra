    ...
    <div className="bg-white min-h-screen text-[#0a2342]">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 space-y-8">
          {programs.map(({ icon: Icon, num, subtitle, title, desc, detail }) => (
            <div key={title} className="bg-[#f9fafb] p-6 sm:p-8 rounded-2xl border border-gray-200 grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
