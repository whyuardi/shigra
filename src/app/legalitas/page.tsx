  ...
  return (
    <div className="bg-white min-h-screen text-[#0a2342]">
      ...
      <section className="py-8 bg-amber-50 border-b border-amber-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 flex items-start gap-4">
      ...
      <section className="py-16 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 space-y-6">
          {certifications.map(({ icon: Icon, code, title, authority, description, statusLabel, note }) => (
            <div key={code} className="bg-[#f9fafb] p-6 sm:p-8 rounded-2xl border border-gray-200 space-y-4">
      ...
      <section className="py-16 bg-[#f9fafb]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {regulatoryRefs.map(({ title, source, url, desc }) => (
              <div key={title} className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex flex-col justify-between space-y-4">
